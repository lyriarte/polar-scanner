module StepMotor28BYJ()
{
	...
	difference(){
		...
		union(){
				...
				color("gold") translate([8,0,-10])	cylinder(h = 19, r = 2.5 + jeu*2, center = true, $fn = 32);
				...
				color("blue") translate([-6,0,-jeu/2]) cube([26 + jeu,18 + jeu,18.9 + jeu], center = true);
			}

				// handle
				color("red") translate([11+jeu*2,0,-16.55]) cube([4 - jeu,5 + jeu*4,6.1], center = true);
				color("red") translate([5-jeu*2,0,-16.55]) cube([4 - jeu,5 + jeu*4,6.1], center = true);
